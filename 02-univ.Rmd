...
model1.1.2 <- MCMCglmm(bwt ~ 1, random = ~animal, ginv = list(animal = Ainv),
...
```{r cache=TRUE}
p.var <- var(gryphon$bwt, na.rm = TRUE)
prior1.4 <- list(G = list(G1 = list(V = 1, nu = 0.002), G2 = list(V = 1,
nu = 0.002), G3 = list(V = 1, nu = 0.002)), R = list(V = 1,
nu = 0.002))
