...
The tutorials and accompanying data files are provided separately for different software packages using `R`: `ASReml-R`, `gremlin`, `MCMCglmm` and `brms` .
...
I recommend to save the data files in a subfolder `data` in the folder you will use as your working directory for R and where you will save your R scripts. It should be noted that the tutorial are using this structure to read or save data.
