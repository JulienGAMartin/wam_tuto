...
<!-- C1 Should we add a sentence about the origin of the dataset !-->
...
ASReml-R is commercial software published by VSN international (http://www.vsni.co.uk/software/asreml/). This package is not free and requires a key access <!-- C2 add the price of it!-->
...
`gremlin` is a little monster appearing if you feed a mugwai after midnight. It is also a great and promising software written by Matt Wolak to fit mixed models using a frequentist approach .
...
<!-- C3 i think we need to add or cite Pierre de Villemereuil, he update his guide for estimating heritability with MCMCglmmm in 2021 ! https://devillemereuil.legtux.org/wp-content/uploads/2021/09/tuto_en.pdf 
But we provide more software and also more futher partition of the variance compare to his guide more focuse on no-gaussian variable-->
