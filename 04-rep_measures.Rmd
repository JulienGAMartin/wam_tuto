gryphonRM# A repeated measures animal model {#rep_measures}
...
model3.3 <- MCMCglmm(laydate ~ 1 + age, random = ~ animal + animal_pe, ginv = list(animal = Ainv),
...
model3.4.IDplusVA <- model3.4$VCV[, "animal"] + model3.4$VCV[,"ID"]
