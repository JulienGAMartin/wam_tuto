...
Here a simple plot of the sex-specific genetic correlation
```{r}

post <- posterior_samples(brms_m2.3, add_chain = T)
blup.bwt.f<-post["sd_animal__bwt_Intercept"]
blup.tarsus.f<-post["sd_animal__tarsus_Intercept"]
blup.bwt.m<-post["sd_animal__bwt_Intercept"]
blup.tarsus.m<-post["sd_animal__tarsus_Intercept"]

BLUP<-cbind(blup.bwt.f,blup.tarsus.f,blup.bwt.m,blup.tarsus.m)


BLUPS<-as_draws_df(brms_m2.2, variable = c("sd"),regex=TRUE)
BLUPS<-var.est^2
...
par(mfrow=c(1,2))
#
plot(blup.tarsus.f~blup.bwt.f,BLUPS,xlab="",ylab="", las=1.2, bty="o", col="white")

arrows(x0=BLUPS$blup.bwt.f,y0=BLUPS$blup.tarsus.f-BLUPS$SE.tarsus,x1=BLUPS$BLUP.btw,y1=BLUPS$blup.tarsus.f+BLUPS$SE.tarsus,col="black",code=3,angle=90,length=0)
arrows(x0=BLUPS$blup.bwt.f-BLUPS$SE.btw,y0=BLUPS$blup.tarsus.f,x1=BLUPS$BLUP.btw+BLUPS$SE.btw,y1=BLUPS$blup.tarsus.f,col="black",code=3,angle=90,length=0)
points(blup.tarsus.f~blup.bwt.f,BLUPS,pch=16,col="red", cex=1.5)
points(blup.tarsus.f~blup.bwt.f,BLUPS,pch=1, col=rgb(0,0,0,0.3), cex=c(1.5))
...
We can plot the cross-sex genetic correlation
```{r}
