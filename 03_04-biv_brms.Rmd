...
plot(c(1, 2) ~ cor.est[, 1], xlim = c(0, 1.001), ylim = c(0, 2.5), xlab = "", ylab = "", col = c("red", "blue"), pch = c(16, 17), cex = 2, yaxt = "n")
...
points(bwt_sex2 ~ bwt_sex1, bl_m2.5, pch = 16, col = "purple", cex = 1.5)
...
points(tarsus_sex2 ~ tarsus_sex1, bl_m2.5, pch = 16, col = "purple", cex = 1.5)
