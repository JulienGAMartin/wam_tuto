...
with(bl_m2.5, arrows(x0 = bwt_sex1, y0 = bwt_sex2_lo, x1 = bwt_sex1, y1 = bwt_sex2_up, col = "black", code = 3, angle = 90, length = 0))
with(bl_m2.5, arrows(x0 = bwt_sex1_lo, y0 = bwt_sex2, x1 = bwt_sex1_up, y1 = bwt_sex2, col = "black", code = 3, angle = 90, length = 0))
...
with(bl_m2.5, arrows(x0 = tarsus_sex1, y0 = tarsus_sex2_lo, x1 = tarsus_sex1, y1 = tarsus_sex2_up, col = "black", code = 3, angle = 90, length = 0))
with(bl_m2.5, arrows(x0 = tarsus_sex1_lo, y0 = tarsus_sex2, x1 = tarsus_sex1_up, y1 = tarsus_sex2, col = "black", code = 3, angle = 90, length = 0))
