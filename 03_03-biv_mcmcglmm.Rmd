...
Neither or these posterior distributions overlaps between each other, which sugest the correlation were not significantly different between sexes. All correlations were significant (posterior distribution did not overlaps with zero) except for the male residual correlation.
